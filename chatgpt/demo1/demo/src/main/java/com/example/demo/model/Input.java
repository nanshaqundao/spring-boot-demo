...
public class Input {
    ...
    public Input withObject(String object) {
        this.object = object;
        return this;
    }
    ...
    public Input withModel(String model) {
        this.model = model;
        return this;
    }
    ...
    public Input withUsage(Usage usage) {
        this.usage = usage;
        return this;
    }
    ...
    public Input withChoices(List<Choice> choices) {
        this.choices = choices;
        return this;
    }
