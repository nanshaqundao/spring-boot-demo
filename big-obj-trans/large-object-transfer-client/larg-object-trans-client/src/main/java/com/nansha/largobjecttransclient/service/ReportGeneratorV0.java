...
/**
 * ReportGeneratorV0 is a service that fetches messages from the PublishingServiceClient and generates a report.
 * It fetches messages in pages and processes them, and then finalizes the report.
 * <p>
 * This is the old version of the ReportGenerator service, which uses a reactive programming model with Mono.
 * </p>
 */
@Service
